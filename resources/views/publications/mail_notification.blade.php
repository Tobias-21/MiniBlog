...
<body >
    <div >
        ...
        <h1 style=" font-size:2em; color:darkorange; font-weight: bold; text-align:center">Un nouvel publication a été publié !</h1>
        <p>Cher(ère), {{ $publication->user->name }}</p>
        <p >Un nouvel publication intitulé "<span style="font-weight: bolder;">{{ $publication->title }}</span>" a été publié sur MiniBlog.</p>
